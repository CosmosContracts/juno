...
junod tx wasm store ./sciprts/cwmodules_example.wasm --from $KEY --gas 5000000 --chain-id $CHAIN_ID --gas-prices 0.025ujuno --node $JUNOD_NODE --broadcast-mode sync --yes
CODE_ID=1

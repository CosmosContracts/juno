...
replace (
	...
	// Pinned to v4.5.1 to clear GHSA-29wx-vh33-7x7r (CVE-2024-51744,
	// ParseWithClaims error-handling flaw, fixed in v4.5.1). go-ethereum
	// already requires v4.5.2 directly, so this replace deliberately uses
	// v4.5.1 to avoid the "same version, two module paths" go.mod conflict
	// — both versions contain the CVE fix.

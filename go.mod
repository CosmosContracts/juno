...
// We do not want to bump for non state breaking as ICA has a breaking patch here
// https://github.com/cosmos/ibc-go/pull/3796/files
replace github.com/cosmos/ibc-go/v7 v7.3.0 => github.com/cosmos/ibc-go/v7 v7.2.0

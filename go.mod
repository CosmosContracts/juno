...
require (
	...
	github.com/cosmos/cosmos-sdk v0.45.13-rc.1.0.20230205152327-472729e40bfc
...
replace (
	...
	// token factory:
	github.com/CosmWasm/token-factory => github.com/CosmosContracts/token-factory v0.0.0-20230206185033-4357f923daa2

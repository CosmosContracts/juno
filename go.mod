...
replace (
	github.com/CosmWasm/wasmd => github.com/notional-labs/wasmd v1.0.0-juno3.0.20220305133611-dd06b256fc65
	github.com/cosmos/cosmos-sdk => github.com/notional-labs/cosmos-sdk v0.44.6-fast

...
replace (
	// use patched wasmd, which sadly had the wrong contract address length.
	github.com/CosmWasm/wasmd => github.com/notional-labs/wasmd v1.0.0-juno3
	// dragonberry
	github.com/confio/ics23/go => github.com/cosmos/cosmos-sdk/ics23/go v0.8.0
	// ensure that we only use cosmos-sdk v0.44.5 because there are breaking changes in v0.44.5+

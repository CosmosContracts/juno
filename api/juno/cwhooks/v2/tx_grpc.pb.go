...
const (
	Msg_UpdateParams_FullMethodName       = "/juno.cwhooks.v2.Msg/UpdateParams"
	Msg_RegisterContract_FullMethodName   = "/juno.cwhooks.v2.Msg/RegisterContract"
	Msg_UnregisterContract_FullMethodName = "/juno.cwhooks.v2.Msg/UnregisterContract"
)
...
func (c *msgClient) UnregisterContract(ctx context.Context, in *MsgUnregisterContract, opts ...grpc.CallOption) (*MsgUnregisterContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UnregisterContract_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil

...
func (x *_GenesisState_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message GenesisState at list field StakingContractAddresses as it is not of Message kind"))
}
...
func (x *_GenesisState_3_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message GenesisState at list field GovContractAddresses as it is not of Message kind"))
}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.StakingContractAddresses) > 0 {
			for _, s := range x.StakingContractAddresses {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.GovContractAddresses) > 0 {
			for _, s := range x.GovContractAddresses {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.GovContractAddresses) > 0 {
			for iNdEx := len(x.GovContractAddresses) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.GovContractAddresses[iNdEx])
				copy(dAtA[i:], x.GovContractAddresses[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.GovContractAddresses[iNdEx])))
				i--
				dAtA[i] = 0x1a
			}
		}
		if len(x.StakingContractAddresses) > 0 {
			for iNdEx := len(x.StakingContractAddresses) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.StakingContractAddresses[iNdEx])
				copy(dAtA[i:], x.StakingContractAddresses[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.StakingContractAddresses[iNdEx])))
				i--
				dAtA[i] = 0x12
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.StakingContractAddresses = append(x.StakingContractAddresses, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
				...
				x.GovContractAddresses = append(x.GovContractAddresses, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *GenesisState) GetStakingContractAddresses() []string {
	if x != nil {
...
func (x *GenesisState) GetGovContractAddresses() []string {
	if x != nil {

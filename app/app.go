...
func New(
	...
	// note - some caveats apply to this as no icaauth exists.
	// see wasmd base and https://github.com/cosmos/ibc-go/blob/v3.0.0/docs/apps/interchain-accounts/integration.md

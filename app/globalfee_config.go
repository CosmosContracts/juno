...
var (
	...
	// customJunoConfigTemplate defines Juno's custom application configuration TOML template.
	customJunoConfigTemplate = `
###############################################################################
...
// CustomConfigTemplate defines Juno's custom application configuration TOML
// template. It extends the core SDK template.
func CustomConfigTemplate() string {
	config := serverconfig.DefaultConfigTemplate
	lines := strings.Split(config, "\n")
	// add the Juno config at the second line of the file
	lines[2] += customJunoConfigTemplate
	return strings.Join(lines, "\n")
}

// CustomAppConfig defines Juno's custom application configuration.

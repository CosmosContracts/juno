...
replace (
	...
	// This is required on Juno version change PRs (Major state breaking)
	// github.com/CosmosContracts/juno/v15 => github.com/CosmosContracts/juno/v15 v15.0.0-20230522191709-aab43aae27c3

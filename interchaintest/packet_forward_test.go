...
func TestPacketForwardMiddleware(t *testing.T) {
	...
	junoConfigA := junoConfig
	junoConfigA.ChainID = chainID_A

	junoConfigB := junoConfig
	junoConfigB.ChainID = chainID_B

	junoConfigC := junoConfig
	junoConfigC.ChainID = chainID_C

	junoConfigD := junoConfig
	junoConfigD.ChainID = chainID_D

	cf := interchaintest.NewBuiltinChainFactory(zaptest.NewLogger(t), []*interchaintest.ChainSpec{
		{
			Name:          "juno",
			ChainConfig:   junoConfigA,
			NumValidators: &numVals,
			NumFullNodes:  &numFullNodes,
		},
		{
			Name:          "juno",
			ChainConfig:   junoConfigB,
			NumValidators: &numVals,
			NumFullNodes:  &numFullNodes,
		},
		{
			Name:          "juno",
			ChainConfig:   junoConfigC,
			NumValidators: &numVals,
			NumFullNodes:  &numFullNodes,
		},
		{
			Name:          "juno",
			ChainConfig:   junoConfigD,
			NumValidators: &numVals,
			NumFullNodes:  &numFullNodes,
		},
	})

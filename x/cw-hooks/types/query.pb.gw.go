...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"juno", "cwhooks", "v2", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Contracts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"juno", "cwhooks", "v2", "contracts", "module"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ContractInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"juno", "cwhooks", "v2", "contracts", "module", "contract_address"}, "", runtime.AssumeColonVerbOpt(false)))
)

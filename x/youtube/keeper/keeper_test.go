...
import (
	...
	"github.com/CosmosContracts/juno/v19/x/youtube/keeper"
...
func (s *IntegrationTestSuite) SetupTest() {
	...
	types.RegisterQueryServer(queryHelper, keeper.NewQuerier(s.app.AppKeepers.YoutubeKeeper))

	s.queryClient = types.NewQueryClient(queryHelper)
	s.bankKeeper = s.app.AppKeepers.BankKeeper
	s.msgServer = keeper.NewMsgServerImpl(s.app.AppKeepers.YoutubeKeeper)
	s.k = s.app.AppKeepers.YoutubeKeeper
}

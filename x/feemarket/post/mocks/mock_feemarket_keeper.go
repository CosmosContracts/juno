...
func (_m *FeeMarketKeeper) GetParams(ctx types.Context) (feemarketv1.Params, error) {
	ret := _m.Called(ctx)
	...
	var r0 feemarketv1.Params
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context) (feemarketv1.Params, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(types.Context) feemarketv1.Params); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(feemarketv1.Params)
	}
...
func (_m *FeeMarketKeeper) GetState(ctx types.Context) (feemarketv1.State, error) {
	ret := _m.Called(ctx)
	...
	var r0 feemarketv1.State
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context) (feemarketv1.State, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(types.Context) feemarketv1.State); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(feemarketv1.State)
	}
...
func (_m *FeeMarketKeeper) SetParams(ctx types.Context, params feemarketv1.Params) error {
...
func (_m *FeeMarketKeeper) SetState(ctx types.Context, state feemarketv1.State) error {

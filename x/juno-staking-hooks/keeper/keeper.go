...
// GetAuthority returns the x/juno-staking-hooks module's authority.
func (k Keeper) GetAuthority() string {
	return k.authority
}

// SetParams sets the x/juno-staking-hooks module parameters.
...
// GetParams returns the current x/juno-staking-hooks module parameters.

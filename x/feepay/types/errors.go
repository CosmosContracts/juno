...
var (
	...
	ErrDuplicateFeePayContract   = errorsmod.Register(ModuleName, 9, "duplicate fee pay contract")
	ErrUnregisteredUsageContract = errorsmod.Register(ModuleName, 10, "wallet usage references an unregistered fee pay contract")
	ErrDuplicateWalletUsage      = errorsmod.Register(ModuleName, 11, "duplicate wallet usage")
)
